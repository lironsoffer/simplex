...
\textbf{Sequence generation.} Each sequence has length equal to the context
window (16 tokens), generated entirely from one component
$k \sim \mathrm{Uniform}(3)$.
The context window was set to 16 to satisfy $N^* < L$: with $N^* \approx 9.6$,
the model has enough context to synchronise to the correct component within a
single sequence.
