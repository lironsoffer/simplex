...
\begin{tabular}{lccc}
\toprule
Layer & CEV (95\%) & CEV (100\%) & Predicted \\
\midrule
0 & 6  & 64 & 8 \\
1 & 5  & 64 & 8 \\
\bottomrule
...
All 64 residual stream dimensions carry non-zero variance; the first 5--6 account for 95\%, revealing a
low-dimensional dominant subspace atop a long noise tail.}
\label{tab:pca}
\end{table}
